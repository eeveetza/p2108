...
% Modified 16OCT25      Ivica Stevanovic (introduced normalization)
...
fidlog = fopen('validation_examples/validation_example_tl_p2108_3_2ray_norm.csv', 'w');
                    ...
                    for iclg = 1:length(Gt_clg)
                        for iLb = 1:length(Lb)
                            ...
                            for i = 1:Ntot
                                ...
                                Lt(i) = tl_p2108_3_2ray_norm(fGHz(ff), theta(it), p, h(ih), hm(ihm), Gt_cld(icld), Gt_clg(iclg), Gr, Lb(iLb));
