...
%     v3    06NOV25     Ivica Stevanovic, OFCOM         Introduced normalization factor
...
%% tl_p2108_3_2ray
fprintf(1,'\n validation of tl_p2108_3_2ray_norm\n')
filename = 'validation_examples/validation_example_tl_p2108_3_2ray_norm.csv';
Y = readcsv(filename);
[nrows, ncols] = size(Y);
Lt = zeros(nrows,1);
sigma = zeros(nrows,1);
...
for i = 1:nrows
    ...
    for ii = 1:Ntot
        ...
        L(ii) = tl_p2108_3_2ray_norm(fGHz(i), theta(i), p, h(i), hm(i), Gt_cld(i), Gt_clg(i), Gr(i), Lb(i));
